...
Employee.create!(
	[
		...
		{employee_name: "Ravi", mobile: "1234567892", password: "ravi@123", role: "admin", email: "ravi@gmail.com", aadhar_card_no: "xxx111xxx", store_id: (Store.find_by(store_name: "Honore").id)},
