...
Employee.create!(
	[
		...
		{employee_name: "Ajay", mobile: "1234567891", password: "ajay@123", role: "master", email: "vijay@gmail.com", aadhar_card_no: "xxx222xxx", store_id: (Store.find_by(store_name: "Honore").id)},
		{employee_name: "Ravi", mobile: "1234567892", password: "ravi@123", role: "account", email: "ravi@gmail.com", aadhar_card_no: "xxx111xxx", store_id: (Store.find_by(store_name: "Honore").id)},
		{employee_name: "Amit", mobile: "1234567893", password: "amit@123", role: "sales", email: "amit@gmail.com", aadhar_card_no: "xxx111xxx", store_id: (Store.find_by(store_name: "Diwan Sahib").id)},
		{employee_name: "Rajesh", mobile: "1234567894", password: "rajesh@123", role: "master", email: "rajesh@gmail.com", aadhar_card_no: "xxx222xxx", store_id: (Store.find_by(store_name: "Diwan Sahib").id)},
		{employee_name: "Rohit", mobile: "1234567895", password: "rohit@123", role: "account", email: "rohit@gmail.com", aadhar_card_no: "xxx111xxx", store_id: (Store.find_by(store_name: "Diwan Sahib").id)}
	]
	)
