    ...
    respond_to do |format|
      if @order.save
        if @customer.customer_measurement != nil
          ...
          @order.order_measurement.jacket_or_shirt_cross_back = @customer.customer_measurement.jacket_or_shirt_hale_back
          @order.order_measurement.jacket_or_shirt_bicep = @customer.customer_measurement.jacket_or_shirt_cross_back
          @order.order_measurement.jacket_or_shirt_cross_front = @customer.customer_measurement.jacket_or_shirt_bicep
          @order.order_measurement.jacket_or_shirt_arm_hole_round = @customer.customer_measurement.jacket_or_shirt_cross_front
